...
class OrderHistoryState extends State<OrderHistory> {
  ...
  Widget build(BuildContext context) {
    ...
    List<Order> _orderList = [
      Order(orderID: '#23164669131', orderSource: 'Shopee', total: '360.000đ', refund: '35,125đ', coupon: 'thang7sale', itemName: 'Điện Thoại Realme C3i (2GB/32GB)', industry: 'Điện Thoại & Phụ Kiện', time: '20/06 - 14:02', status: 'Đang xử lý', isStatus: true),
      Order(orderID: '#23164669131', orderSource: 'Shopee', total: '360.000đ', refund: '35,125đ', coupon: 'thang7sale', itemName: 'Điện Thoại Realme C3i (2GB/32GB)', industry: 'Điện Thoại & Phụ Kiện', time: '20/06 - 14:02', status: 'Đang xử lý', isStatus: true),
      Order(orderID: '#23164669131', orderSource: 'Shopee', total: '360.000đ', refund: '35,125đ', coupon: 'thang7sale', itemName: 'Điện Thoại Realme C3i (2GB/32GB)', industry: 'Điện Thoại & Phụ Kiện', time: '20/06 - 14:02', status: 'Đang xử lý', isStatus: true),
      Order(orderID: '#23164669131', orderSource: 'Shopee', total: '360.000đ', refund: '35,125đ', coupon: 'thang7sale', itemName: 'Điện Thoại Realme C3i (2GB/32GB)', industry: 'Điện Thoại & Phụ Kiện', time: '20/06 - 14:02', status: 'Đang xử lý', isStatus: true),
